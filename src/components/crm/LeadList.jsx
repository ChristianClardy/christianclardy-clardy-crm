    ...
    <div className="space-y-6 px-6 pb-6 lg:px-8 lg:pb-8">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        {filteredLeads.map((lead) => (
          <Link key={lead.id} to={`/LeadDetail?id=${lead.id}`} className="block rounded-3xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md hover:border-slate-300">
