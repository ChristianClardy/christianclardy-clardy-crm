...
export default function PaymentSummaryReceiptModal({ open, onClose, payments = [], project, client, company, contractValue = 0 }) {
              ...
              <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 20 }}>
                <div style={{ minWidth: 260 }}>
                  ...
                  <div style={{
                    ...
                    <div>
                      <div style={{ fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", color: "#15803d" }}>
                        Total Paid to Date
                      </div>
                  ...
                  {/* Remaining balance (only if contract value is set) */}
                  {contractValue > 0 && (
                    <div style={{
                      display: "flex", justifyContent: "space-between", alignItems: "center",
