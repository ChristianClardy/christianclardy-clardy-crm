...
export default function PaymentReceiptModal({ open, onClose, payment, project, client, company }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto p-0">
        {/* Custom header — Download PDF button sits left of the auto close X */}
        <div className="flex items-center justify-between border-b border-slate-200 px-6 py-4 pr-14">
          ...
          <Button onClick={handleDownload} disabled={downloading} size="sm">
            {downloading ? (
              <><Loader2 className="h-4 w-4 animate-spin mr-1" />Preparing...</>
            ) : (
            ...
            <div style={{ border: "1px solid #e2e8f0", borderTop: "none", borderRadius: "0 0 8px 8px", padding: "28px 32px", backgroundColor: "#fff" }}>
              ...
              <div style={{ display: "flex", justifyContent: "flex-end" }}>
                <div style={{
                  ...
                  borderRadius: 8, padding: "16px 24px", textAlign: "right", minWidth: 200,
                }}>
                  <div style={{ fontSize: 12, color: "#94a3b8", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.08em" }}>
                    Amount Received
                  </div>
